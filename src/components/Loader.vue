        ...
        <g id="SVGRepo_iconCarrier">
          <g transform="translate(1 1)">
            <g>
              <g>
                <path
                  class="loader-stroke loader-stroke--outer"
                ...
                />
                <path
                  class="loader-stroke loader-stroke--arrow"
...
onMounted(() => {
  ...
  const strokes = Array.from(
    svg.querySelectorAll<SVGPathElement | SVGCircleElement>(".loader-stroke"),
  );
  ...
  tl = gsap.timeline({
    ...
    onRepeat: () => {
      if (hasEmittedCycle) return;
      hasEmittedCycle = true;
      emit("cycle");
    },
  });
...
.loader-blob {
  ...
  height: auto;
  animation:
    blobFloat 2s ease-in-out infinite,
    blobRotate 5s linear infinite;
}
